...
public class EmploiController {
    ...
    public ResponseEntity<Emploi> updateEmploi(@RequestBody Emploi newEmploi) {
        ...
        for (int i = 0; i < listNiveauOfNewEmploi.size(); i++) {
            ...
            logger.info("PUT API : -----" + newNiveauCompetenceRe.size() + " == " + editedNiveauCompetenceRe.size());

            for (CompetenceRe cr : newNiveauCompetenceRe) {

                logger.info("INFO ABT NEW COMPT-RE : -----" + cr.getType() + "_" + cr.getName() + "_" + cr.getNiveauRequis());
                ...
                logger.info("PUT API : -----" + competenceRe.getType() + "_" + competenceRe.getName() + "_" + competenceRe.getNiveauRequis());
